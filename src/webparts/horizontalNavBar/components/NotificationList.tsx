...
const NotificationList = ({ NotificationArray, handleNotificationClick, OnClearall }: any) => {
    ...
    return (
        <div>
            ...
            <hr style={{ width: '100%', margin: '0 0 8px 0', borderColor: '#ccc' }} />
            <div style={{
                display: 'flex',
                ...
                <h5 style={{ textDecoration: 'underline', marginLeft: '5px', cursor: 'pointer' }} onClick={goToNext}>
                    View All
                </h5>
                <h5 style={{ marginRight: '5px', cursor: 'pointer' }} onClick={goToSettings}>
                    <Settings size={18} />
                </h5>
            </div>
