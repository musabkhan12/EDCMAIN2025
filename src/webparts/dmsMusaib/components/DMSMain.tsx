...
`;
  ...
  const AuditReportFunc = async (event: React.MouseEvent<HTMLButtonElement>) => {
    const selectedTextDiv = document.getElementById('selectedText');
    const breadcrumbElement = document.getElementById("breadcrumb");
    breadcrumbElement.style.display = 'none';
    selectedTextDiv.style.display = 'none';
    ...
    setDynamicContent(null);
    setSelectedText(null);
    window.location.hash = "/AnnualAuditReport";
  }
  ...
  <button   className="dropdown-item" type="button">change request       </button>
    ...
    <button className="dropdown-item" type="button">NC            /button>
           ...
           */}
                          ...
                          >Annual Audit Report </Dropdown.Item>
                ...
                <div className="librarydata">
                     ...
                     } */}
                  {
                    ...
                    {listorgriddata === 'Memorandum' && (
                        ...
                        {listorgriddata === 'AnnualAuditReport' && (
                          <AnnualAuditReport
                            {...props}
                          />
                        )}
