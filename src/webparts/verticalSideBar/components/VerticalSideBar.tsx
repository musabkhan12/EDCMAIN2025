...
import { Airplay, Calendar, File, Image, Clipboard, Bell, Users, Activity, Sun, Moon, Cpu, Rss, Maximize, Settings, Search, ChevronsDown, ChevronDown, Menu, User, Codepen, Command, BookOpen, Folder , Database, Globe, FileText, Link2 , List} from 'react-feather';
...
//                 <ul className="sub-menu blank navlinkcss" style={{ background: 'transparent', padding: 'unset', alignItems: 'start', boxShadow: '0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12)' }}>
//                   <div style={{
//                     color: '#fff', textDecoration: 'none', background: '#f37421', paddingLeft: '0.5rem',
//                     display: 'flex', height: '40px', alignItems: 'center'
//                   }} >
//                     <li className='' style={{ background: '#f37421', color: 'white' }} >
